...
import com.lambui.healthcare_doctor.utils.InternetManager
...
class RetrofitException : RuntimeException {
  ...
  private val TIME_OUT = "Timeout reached"
  private val SERVER_ERROR = "A system error has occurred"
  private val CAN_NOT_CONNECT_TO_SERVER = "Internet connection seems to be offline."
  ...
  companion object {
    ...
    fun toRefreshTokenError(cause: Throwable): RetrofitException{
      return RetrofitException(Type.TOKEN, cause)
    }
  }
}