package com.lambui.healthcare_doctor.data.source.remote.api.middleware

import android.util.Log
import androidx.annotation.NonNull
import com.lambui.healthcare_doctor.data.source.remote.api.error.ErrorResponse
...
class RxErrorHandlingCallAdapterFactory private constructor() : CallAdapter.Factory() {
    private val original: RxJava2CallAdapterFactory =
        RxJava2CallAdapterFactory.createWithScheduler(Schedulers.single())
    ...
    internal inner class RxCallAdapterWrapper<R>(
        ...
        private fun convertToBaseException(throwable: Throwable): RetrofitException {
            ...
            if (throwable is RefreshTokenException) {
                return RetrofitException.toRefreshTokenError(throwable)
            }
