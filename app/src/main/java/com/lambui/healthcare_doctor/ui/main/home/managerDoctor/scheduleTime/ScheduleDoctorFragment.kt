...
class ScheduleDoctorFragment : BaseFragment<ScheduleDoctorVM>() {
  ...
  override fun onSubscribeObserver() {
    with(viewModelx) {
      ...
      updateWorkingSchedule.observe(this@ScheduleDoctorFragment, Observer {
  ...
  override fun registerOnClick() {
    launchDisposable {
      RxView.clickCheckNetwork(
        ...
        if (validate()) {
          showConfirmDialog(resources.getString(R.string.confirm_tittle_dialog),
            resources.getString(R.string.confirm_content_dialog),
